...
int lorawan_init(LoRaMacRegion_t region)
{
    ...
    SpiInit(
        &SX126x.Spi, 
        SPI_1,
        sx126x_settings.spi.mosi /*MOSI*/,
        sx126x_settings.spi.miso /*MISO*/,
        sx126x_settings.spi.sck  /*MISO*/,
        sx126x_settings.spi.nss /*NSS*/
    );
...
// I will rewrite this function again
